...
namespace {
    ...
    class Google extends \PulkitJalan\Google\Facades\Google{
        ...
        public static function getClient(){
            return \PulkitJalan\Google\Client::getClient();
        }
        ...
        public static function make($service){
            return \PulkitJalan\Google\Client::make($service);
        }
    ...
    class Sheets extends \GoogleSheets\Facades\Sheets{
        ...
        public static function setService($service){
            return \GoogleSheets\Sheets::setService($service);
        }
        ...
        public static function getService(){
            return \GoogleSheets\Sheets::getService();
        }
        ...
        public static function spreadsheet($spreadsheetId){
            return \GoogleSheets\Sheets::spreadsheet($spreadsheetId);
        }
        ...
        public static function spreadsheetByTitle($title){
            return \GoogleSheets\Sheets::spreadsheetByTitle($title);
        }
        ...
        public static function sheet($sheet){
            return \GoogleSheets\Sheets::sheet($sheet);
        }
        ...
        public static function sheetById($sheetId){
            return \GoogleSheets\Sheets::sheetById($sheetId);
        }
        ...
        public static function sheetList(){
            return \GoogleSheets\Sheets::sheetList();
        }
         ...
         */
        public static function all(){
            return \GoogleSheets\Sheets::all();
        }
        ...
        public static function first(){
            return \GoogleSheets\Sheets::first();
        }
        ...
        public static function update($value, $valueInputOption = 'RAW'){
            return \GoogleSheets\Sheets::update($value, $valueInputOption);
        }
        ...
        public static function append($value, $valueInputOption = 'RAW', $insertDataOption = 'OVERWRITE'){
            return \GoogleSheets\Sheets::append($value, $valueInputOption, $insertDataOption);
        }
        ...
        public static function ranges(){
            return \GoogleSheets\Sheets::ranges();
        }
        ...
        public static function range($range){
            return \GoogleSheets\Sheets::range($range);
        }
        ...
        public static function majorDimension($majorDimension){
            return \GoogleSheets\Sheets::majorDimension($majorDimension);
        }
        ...
        public static function dateTimeRenderOption($dateTimeRenderOption){
            return \GoogleSheets\Sheets::dateTimeRenderOption($dateTimeRenderOption);
        }
        ...
        public static function spreadsheetList(){
            return \GoogleSheets\Sheets::spreadsheetList();
        }
        
        /**
         * 
         *
         * @param \GoogleSheets\Google_Service_Drive\\Google_Service $drive
         * @static 
         */
        public static function setDriveService($drive){
            return \GoogleSheets\Sheets::setDriveService($drive);
        }
        ...
        public static function getDriveService(){
            return \GoogleSheets\Sheets::getDriveService();
        }
        ...
        public static function spreadsheetProperties(){
            return \GoogleSheets\Sheets::spreadsheetProperties();
        }
        ...
        public static function sheetProperties(){
            return \GoogleSheets\Sheets::sheetProperties();
        }
        ...
        public static function get(){
            return \GoogleSheets\Sheets::get();
        }
        ...
        public static function collection($header, $rows){
            return \GoogleSheets\Sheets::collection($header, $rows);
        }
