...
use App\Entities\AuthUser as Authenticatable;
 ...
 * @property bool $system_admin
 * @property string $remember_token
 * @property \Carbon\Carbon $created_at
 * @property \Carbon\Carbon $updated_at
 * @property string $deleted_at
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Entities\UserRole[] $roles
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Entities\User whereSystemAdmin($value)
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Entities\User whereLang($value)
 */
class User extends Authenticatable implements Transformable
{
    ...
    protected $fillable = ['name', 'email', 'password', 'system_admin', 'lang'];
